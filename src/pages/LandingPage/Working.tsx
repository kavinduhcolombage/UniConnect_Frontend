...
const Working = () => {
    ...
    return <div className="mt-5 pb-5">
        <div className="text-4xl max-[850px]:text-3xl text-center font-semibold mb-3">How to  <span className="text-blue-500">Apply</span></div>
        ...
        <div className="flex px-16 max-[900px]:px-8 max-[500px]:py-2 max-[600px]:px-4 max-[400px]:px-0 justify-between items-center relative">
            ...
            <div className="flex flex-col gap-7 max-[600px]:gap-3 w-[55%] max-[750px]:w-[65%] max-[500px]:w-[70%] max-[400px]:pr-3">
                <div className="flex items-center justify-around gap-4">
                    ...
                    <div>
                        <div className="text-blue-700 text-xl max-[850px]:text-lg max-[750px]:text-base max-[500px]:text-sm font-semibold">Build your resume</div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="text-blue-700 text-xl max-[850px]:text-lg max-[750px]:text-base max-[500px]:text-sm font-semibold">Apply for job</div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="text-blue-700 text-xl max-[850px]:text-lg max-[750px]:text-base max-[500px]:text-sm font-semibold">Get Hired</div>
