...
const Profile = (props: any) => {
    return <div className="w-2/3">
        ...
        <div className="px-3 mt-22">
            <div className="text-3xl font-semibold flex justify-between">{props.name}<Button
        ...
        <div className="px-3">
            ...
            <div className="text-xs text-justify">{props.about}</div>
        </div>
        <Divider mx="xs" my="xl" />
        <div className="px-3">
            ...
            <div className="flex flex-wrap gap-2">
                ...
                {
                    props.skills.map((skill: any, index: any) => <div key={index} className="bg-blue-400 text-sm font-medium bg-opacity-15 rounded-3xl text-gray-600 px-3 py-1">{skill}</div>)
                }
