...
import { IconBriefcase, IconCheck, IconDeviceFloppy, IconMapPin, IconPencil } from "@tabler/icons-react";
...
const Info = () => {
    ...
    return (<>
        <div className="text-3xl font-semibold flex justify-between">
            {profile.name}
            <ActionIcon onClick={handleClick} size="lg" color="blue" variant="subtle">
        ...
        </div>
        {
            edit ? <><div className="flex gap-10 [&>*]:w-1/2">
                ...
                <div className="p-2 flex gap-2 justify-end">
                    ...
                    <Button onClick={handleClick} color="red" variant="light">Cancel</Button>
