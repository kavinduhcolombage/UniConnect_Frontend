    ...
    return <div className="pb-5 pt-5 flex flex-col bg-blue-950">
        <div className="flex flex-wrap gap-5 justify-around items-center w-full">
            <div className="w-1/3 max-[600px]:w-[80%] flex flex-col gap-2">
                ...
                <div className="flex gap-5 max-[750px]:gap-2 text-blue-500 [&>div]:bg-gray-300 [&>div]:p-2 [&>div]:rounded-full [&>div]:cursor-pointer max-[400px]:[&>div]:p-1.5 [&>div:hover]:bg-blue-700 [&>div:hover]:text-white justify-around">
            ...
            <div className="flex gap-15 justify-around max-[750px]:gap-10 max-[700px]:gap-6 max-[600px]:w-[90%]">
                ...
                <div className="text-blue-200">
                    <div className="text-2xl max-[700px]:text-xl font-semibold mb-4 max-[400px]:mb-3 text-blue-500">Product</div>
                ...
                <div className="text-blue-200">
                    <div className="text-2xl max-[700px]:text-xl font-semibold mb-4 max-[400px]:mb-3 text-blue-500">Company</div>
                    <div className="text-sm max-[400px]:text-xs">
                ...
                <div className="text-blue-200">
                    <div className="text-2xl max-[700px]:text-xl font-semibold mb-4 max-[400px]:mb-3 text-blue-500">Support</div>
                    <div className="text-sm max-[400px]:text-xs">
        ...
        <div className="w-full text-center text-blue-400 text-xs mt-6">
